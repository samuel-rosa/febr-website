...
```{r, echo=FALSE, fig.cap="Os mais novos integrantes da equipe do febr: Matheus, ao fundo, Mikael, à frente, e Rander, à direita. Ao centro, Alessandro, coordenador do febr"}
knitr::include_graphics("img/equipe-set-2018.jpg")
```
